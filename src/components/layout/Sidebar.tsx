...
interface NavItem   { label: string; href?: string; icon: (p: { className?: string }) => React.ReactElement; children?: NavChild[] }
interface NavSection{ title: string; items: NavItem[] }

// ── Icons ─────────────────────────────────────────────────────────────────────

const I = {
  Overview:     ({ className }: { className?: string }) => <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}><path strokeLinecap="round" strokeLinejoin="round" d="M3.75 6A2.25 2.25 0 0 1 6 3.75h2.25A2.25 2.25 0 0 1 10.5 6v2.25a2.25 2.25 0 0 1-2.25 2.25H6a2.25 2.25 0 0 1-2.25-2.25V6ZM3.75 15.75A2.25 2.25 0 0 1 6 13.5h2.25a2.25 2.25 0 0 1 2.25 2.25V18a2.25 2.25 0 0 1-2.25 2.25H6A2.25 2.25 0 0 1 3.75 18v-2.25ZM13.5 6a2.25 2.25 0 0 1 2.25-2.25H18A2.25 2.25 0 0 1 20.25 6v2.25A2.25 2.25 0 0 1 18 10.5h-2.25a2.25 2.25 0 0 1-2.25-2.25V6ZM13.5 15.75a2.25 2.25 0 0 1 2.25-2.25H18a2.25 2.25 0 0 1 2.25 2.25V18A2.25 2.25 0 0 1 18 20.25h-2.25A2.25 2.25 0 0 1 13.5 18v-2.25Z" /></svg>,
  Users:        ({ className }: { className?: string }) => <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}><path strokeLinecap="round" strokeLinejoin="round" d="M15 19.128a9.38 9.38 0 0 0 2.625.372 9.337 9.337 0 0 0 4.121-.952 4.125 4.125 0 0 0-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 0 1 8.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0 1 11.964-3.07M12 6.375a3.375 3.375 0 1 1-6.75 0 3.375 3.375 0 0 1 6.75 0Zm8.25 2.25a2.625 2.625 0 1 1-5.25 0 2.625 2.625 0 0 1 5.25 0Z" /></svg>,
  Shield:       ({ className }: { className?: string }) => <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}><path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75 11.25 15 15 9.75m-3-7.036A11.959 11.959 0 0 1 3.598 6 11.99 11.99 0 0 0 3 9.749c0 5.592 3.824 10.29 9 11.623 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.571-.598-3.751h-.152c-3.196 0-6.1-1.248-8.25-3.285Z" /></svg>,
  Transactions: ({ className }: { className?: string }) => <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}><path strokeLinecap="round" strokeLinejoin="round" d="M7.5 21 3 16.5m0 0L7.5 12M3 16.5h13.5m0-13.5L21 7.5m0 0L16.5 12M21 7.5H7.5" /></svg>,
  ...
  SUPER_ADMIN: [
    {
      title: "MAIN MENU",
      items: [
        { label: "Overview",     href: "/super-admin/overview",     icon: I.Overview },
        { label: "Users",        href: "/super-admin/users",         icon: I.Users,
          children: [
            { label: "All Users",    href: "/super-admin/users" },
            { label: "KYC Queue",    href: "/super-admin/users/kyc-queue" },
          ]},
        { label: "Admin Management", href: "/super-admin/admin-management", icon: I.AdminMgmt,
          children: [
            { label: "All Admins",          href: "/super-admin/admin-management" },
            { label: "Roles & Permissions", href: "/super-admin/admin-management/roles" },
          ]},
        { label: "Transactions", href: "/super-admin/transactions", icon: I.Transactions },
      ],
    },
    {
      title: "SECURITY",
      items: [
        { label: "Fraud & Security", href: "/super-admin/fraud-security", icon: I.Fraud,
          children: [
    ...
    },
    {
      ...
      items: [
        { label: "Platform Analytics", href: "/super-admin/platform-analytics", icon: I.Analytics,
          children: [
        ...
        { label: "Notifications", href: "/super-admin/notifications", icon: I.Bell,
          children: [
            { label: "Broadcasts", href: "/super-admin/notifications" },
            { label: "Templates",  href: "/super-admin/notifications/templates" },
          ]},
        { label: "System Config", href: "/super-admin/system-config", icon: I.Cog,
          children: [
  ...
  FINANCIAL_ADMIN: [
    {
      title: "MAIN MENU",
      items: [
        { label: "Overview",     href: "/financial-admin/overview",     icon: I.Overview },
        { label: "Transactions", href: "/financial-admin/transactions",  icon: I.Transactions,
          children: [
        ...
        { label: "Wallets",      href: "/financial-admin/wallets",       icon: I.Wallet,
          children: [
            { label: "All Wallets",      href: "/financial-admin/wallets" },
            { label: "Funding Activity", href: "/financial-admin/wallets/funding" },
          ]},
        { label: "Virtual Cards", href: "/financial-admin/virtual-cards", icon: I.Card },
      ],
    },
    {
      title: "VERIFICATION",
      items: [
        { label: "KYC Queue", href: "/financial-admin/kyc-queue", icon: I.KYC },
      ],
    },
    {
      title: "ANALYTICS",
      items: [
        { label: "Budgets & Spending", href: "/financial-admin/budgets-spending", icon: I.Budget,
          children: [
            { label: "Overview",    href: "/financial-admin/budgets-spending" },
            { label: "Categories",  href: "/financial-admin/budgets-spending/categories" },
          ]},
        { label: "Savings Vaults", href: "/financial-admin/saving-vaults", icon: I.Savings,
          children: [
            { label: "Vault Activity", href: "/financial-admin/saving-vaults" },
            { label: "Goals",          href: "/financial-admin/saving-vaults/goals" },
          ]},
        { label: "Subscriptions", href: "/financial-admin/subscriptions", icon: I.Subscriptions },
        { label: "Cash Flow",     href: "/financial-admin/cash-flows",    icon: I.CashFlow },
      ],
    },
    {
      title: "COMPLIANCE",
      items: [
        { label: "Compliance", href: "/financial-admin/compliance", icon: I.Compliance,
          children: [
            { label: "Overview", href: "/financial-admin/compliance" },
            { label: "Reports",  href: "/financial-admin/compliance/reports" },
          ]},
        { label: "Reports", href: "/financial-admin/reports", icon: I.Report },
      ],
    },
  ],
  ...
  SUPPORT_ADMIN: [
    {
      title: "MAIN MENU",
      items: [
        { label: "Overview", href: "/support-admin/overview", icon: I.Overview },
        { label: "Tickets",  href: "/support-admin/tickets",  icon: I.Ticket,
          children: [
            { label: "All Tickets", href: "/support-admin/tickets" },
            { label: "Escalated",   href: "/support-admin/tickets/escalated" },
          ]},
        { label: "Users", href: "/support-admin/users", icon: I.Users },
      ],
    },
    {
      title: "RESOLUTION",
      items: [
        { label: "Disputes",      href: "/support-admin/disputes",      icon: I.Dispute },
        { label: "Announcements", href: "/support-admin/announcements", icon: I.Megaphone },
      ],
    },
  ],
...
function NavItemRow({ item, onNavigate }: { item: NavItem; onNavigate?: () => void }) {
  ...
  const idleRow   = "text-gray-600 hover:bg-gray-50 hover:text-gray-900";
...
function SidebarContent({ role, userName, onNavigate }: { role: AdminRole; userName: string; onNavigate?: () => void }) {
          ...
          <div key={section.title}>
            ...
            <div className="space-y-0.5">
              {section.items.map((item) => (
                <NavItemRow key={item.label} item={item} onNavigate={onNavigate} />
              ))}
            </div>
          </div>
        ))}
...
export default function Sidebar({ role, userName, mobileOpen, onClose }: SidebarProps) {
  ...
  return (
    <>
      ...
      {/* Backdrop */}
      <div
        className={`lg:hidden fixed inset-0 z-30 bg-black/40 backdrop-blur-sm transition-opacity duration-300 ${mobileOpen ? "opacity-100 pointer-events-auto" : "opacity-0 pointer-events-none"}`}
        onClick={onClose}
        aria-hidden="true"
      />
